...
const signUpSchema = checkSchema({
  firstName: {
    ...
    isEmpty: {
      negated: true,
      errorMessage: (_, { req }) => req.t("required", { ns: 'validations', key: req.t("firstName") })
    },
  },
  lastName: {
    trim: true,
    ...
    isEmpty: {
      negated: true,
      errorMessage: (_, { req }) => req.t("required", { ns: 'validations', key: req.t("lastName") })
    },
  },
  email: {
    escape: true,
...
export default {
  register: [signUpSchema, errorHandler],
